...
const PAYMENT_API_NAME_MAP: Record<string, string> = {
  ...
  "approval": "payment/api/approval-tid.md",
  ...
  "cancellation": "payment/api/cancellation.md",
  "cancel": "payment/api/cancellation.md",
  "결제취소": "payment/api/cancellation.md",
  "취소": "payment/api/cancellation.md",
  "refund": "payment/api/refund.md",
  "환불": "payment/api/refund.md",
  "escrow-delivery": "payment/api/escrow-delivery.md",
  "에스크로": "payment/api/escrow-delivery.md",
  "배송등록": "payment/api/escrow-delivery.md",
  ...
  "티머니페이": "payment/api/registration.md",
  "tmoney": "payment/api/registration.md",
  "모바일티머니": "payment/api/registration.md",
